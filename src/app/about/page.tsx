  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-12 lg:py-24 space-y-24">
        {/* Intro Section */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center animate-fade-in">
          ...
          <div className="space-y-8">
            <h1 className="font-headline text-6xl lg:text-8xl font-bold tracking-tighter leading-tight">
        ...
        {/* Contact Grid */}
        <section className="space-y-12 animate-fade-in" style={{ animationDelay: '200ms' }}>
          <h2 className="font-headline text-4xl font-bold border-b border-white/10 pb-6">LET'S CONNECT</h2>
        ...
        {/* Services / Philosophy */}
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24 animate-fade-in" style={{ animationDelay: '400ms' }}>
          <div className="space-y-6">
            <h3 className="font-headline text-2xl font-bold text-primary">01. Strategy</h3>
          ...
          <div className="space-y-6">
            <h3 className="font-headline text-2xl font-bold text-primary">02. Design</h3>
          ...
          <div className="space-y-6">
            <h3 className="font-headline text-2xl font-bold text-primary">03. Development</h3>
